...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: BYT Accommodation Update

-----------------------------------------------------------------------------------*/

// Add function to widgets_init that'll load our widget.
add_action( 'widgets_init', 'byt_widget_accommodation_updates' );

// Register widget.
function byt_widget_accommodation_updates() {
	register_widget( 'byt_Widget_Accommodation_Update' );
}

// Widget class.
class byt_widget_accommodation_update extends WP_Widget {

	/*-----------------------------------------------------------------------------------*/
	/*	Widget Setup
	/*-----------------------------------------------------------------------------------*/
	
	function byt_Widget_Accommodation_Update() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'byt_Widget_Accommodation_Update', 'description' => __('BookYourTravel: Header Search', 'bookyourtravel') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 260, 'height' => 600, 'id_base' => 'byt_Widget_Accommodation_Update' );

		/* Create the widget. */
		$this->WP_Widget( 'byt_Widget_Accommodation_Update', __('BookYourTravel: Accommodation Update', 'bookyourtravel'), $widget_ops, $control_ops );
	}
