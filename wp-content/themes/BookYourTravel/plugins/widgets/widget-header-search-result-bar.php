...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: BYT Header Search Result bar

-----------------------------------------------------------------------------------*/

// Add function to widgets_init that'll load our widget.
add_action( 'widgets_init', 'byt_header_search_widgets' );

// Register widget.
function byt_header_search_widgets() {
	register_widget( 'byt_Header_Search_Widget' );
}

// Widget class.
class byt_header_search_widget extends WP_Widget {

	/*-----------------------------------------------------------------------------------*/
	/*	Widget Setup
	/*-----------------------------------------------------------------------------------*/
	
	function byt_Header_Search_Widget() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'byt_Header_Search_Widget', 'description' => __('BookYourTravel: Header Search', 'bookyourtravel') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 260, 'height' => 600, 'id_base' => 'byt_Header_Search_Widget' );

		/* Create the widget. */
		$this->WP_Widget( 'byt_Header_Search_Widget', __('BookYourTravel: Header Search', 'bookyourtravel'), $widget_ops, $control_ops );
	}
