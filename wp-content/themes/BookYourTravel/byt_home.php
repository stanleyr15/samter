...
if (have_posts()) {
    ...
    <div class="row"> 
        <?php
        get_template_part('includes/parts/home-custom-search', 'hotel');
    }
    ?>
 ...
 <!--<img src="images/slider.jpg" width="615" height="151" alt="">-->
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-5">
        <div class="customer-servicecont partnerwithus"> 
